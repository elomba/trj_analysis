...
class SALR(LAMMPSPairPotential):
    def __init__(self):
        ...
        urcb = sig10*r10inv+k1*np.exp(-a1b*rcb)-k2*np.exp(-a2b*rcb)
        self.coeff = {'1'  : {'1'  : (eps,sig10,k1, k2, a1, a2, urc, rc),
                              '2'  : (0.5*eps,sig10,k1, k2, a1, a2, urc, rc)},
                      '2'  : {'1'  : (0.5*eps,sig10,k1, k2, a1, a2, urc, rc),
                              '2'  : (epsb,sig10,k1, k2, a1b, a2b, urcb, rcb)}}
