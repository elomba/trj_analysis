module mol_tools
    ...
    ! This code has been mostly generated by Gemini 3.1
    !
    ! IMPORTANT !
    ! It requires a topology file (lammps data file) to assess molecular topology
    !
    !===============================================================================
    ! Module: mol_tools
    !===============================================================================
    !
    ! uses derived data types defined in common.cuf
    !
    ! Molecular Metadata Type, identifies to which molecules (mol in LAMMPS) and atom belong, to which Type
    ! of molecule (program's internal identification) and the rotational deg. of freedom of the molecule
    !
    !     type :: AtomMolMap
    ...
    !     end type SystemType
    !
    ! Species defition metadata type
    !
    !     type :: SpeciesType
...
contains
    ...
    subroutine set_equipartition_cte()
        !
        ! Define constant to transform kinetic energy into temperature
        !
        implicit none
        integer :: s, tsum
        if (topol) then
